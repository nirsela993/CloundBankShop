...
<body>
	...
	<body>
		...
		<div class="container">
			...
			The IBM book shop is made by Nir and Omer and contains 0 Diffrent Books
			</div>
		...
		<script >
			window.loadBooks = ()=>{
				bookStoreAPI.getNumberOfTitlesAvalible((numberOfTitles)=>{
					document.getElementById('pageContent').innerHTML = 
						document.getElementById('pageContent').innerHTML.replace("0", numberOfTitles)
				})
			}
			loadBooks()
		</script>
